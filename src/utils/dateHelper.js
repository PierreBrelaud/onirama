...
const formatDateAsString = (objDate, displayDay) => {
    ...
    return daysStr + z(objDate.hours) + ':' + z(objDate.minutes) + ':' + z(objDate.seconds);
}
...
export { timeStampToDate, displayDate, displayTimestamp, timeDiffCalc, dhmsToSeconds, formatDateAsString }