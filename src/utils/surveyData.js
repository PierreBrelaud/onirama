...
export const dreamTypes = [
    ...
    { id: 2, value: 'erotic', display: 'Érotique', description: 'Fusionnel, exaltant et plus si affinité', colors: ['#370FA0', '#D01119', '#D958BB'] },
...
export const getTypeDisplay = (typeId) => {
    return dreamTypes[typeId].display
}
